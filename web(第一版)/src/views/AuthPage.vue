    ...
    <el-card class="auth-card">
      ...
      <div v-if="userState.token" class="auth-logged-in">
        <div class="auth-header">
          ...
          <el-tag size="large" type="success" effect="dark" class="role-tag">{{ userState.role }}</el-tag>
...
async function handleSubmit() {
  ...
  try {
    if (isRegister.value) {
      ...
      // 这里的顺序必须是 (id, username, role, token)！
...
.auth-title { font-size: 26px; font-weight: 800; color: #000; margin-bottom: 12px; }
.role-tag { font-weight: 800 !important; font-size: 14px !important; }
.clinic-title { font-size: 30px; font-weight: 900; color: #0f172a; letter-spacing: -1px; margin-bottom: 8px; }
.clinic-subtitle { color: #334155; font-size: 15px; font-weight: 600; }

.auth-tabs { margin-bottom: 25px; }
:deep(.el-tabs__item) { font-size: 16px !important; font-weight: 800 !important; color: #334155 !important; }
:deep(.is-active) { color: #10b981 !important; }

:deep(.el-input__wrapper) { padding: 12px 16px !important; background: #fff !important; border: 1px solid #cbd5e1 !important; }
:deep(.el-input__inner) { font-size: 15px !important; font-weight: 600 !important; color: #000 !important; }

.submit-btn { width: 100%; height: 54px !important; font-size: 18px !important; font-weight: 800 !important; margin-top: 20px; text-shadow: 0 1px 2px rgba(0,0,0,0.2); }
